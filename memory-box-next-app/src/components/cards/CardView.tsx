      ...
      <div className="p-6">
        ...
        {reviewMode ? (
          <div className="mb-6">
            ...
            {isQuotationVisible ? (
              <blockquote className="text-lg leading-relaxed text-zinc-900 dark:text-zinc-100 italic border-l-4 border-indigo-500 pl-4 py-2">
                {card.quotation}
              </blockquote>
            ) : (
          ...
          <blockquote className="text-lg leading-relaxed text-zinc-900 dark:text-zinc-100 italic border-l-4 border-indigo-500 pl-4 py-2 mb-6">
            {card.quotation}
          </blockquote>
        )}
